...
4. position编码，相比embedding的值太大了。需要除以30左右的一个值
5. 模型用xavier/kaiming初始化，能够明显帮助到收敛

截止2025/2/24，我这代码还不能收敛，180个epoch后，token粒度的准确率率75%，seq粒度的准确率16%。一定是哪里不对：

```shell
Input: 1920-357, Predicted: -1657$, Target: 1563$
Input: 384+939, Predicted: 9730$$, Target: 1323$
Input: 7431+4356, Predicted: 11187$, Target: 11787$
Input: 2310-2981, Predicted: -671$$, Target: -671$
Input: 3926+1671, Predicted: 4787$$, Target: 5597$
Input: 313+3766, Predicted: 4109$$, Target: 4079$
Input: 1247-1515, Predicted: -268$$, Target: -268$
Input: 9153+7192, Predicted: 16275$, Target: 16345$
Input: 5319-3202, Predicted: 2117$$, Target: 2117$
Input: 1935+2334, Predicted: 3799$$, Target: 4269$
Input: 9881+2994, Predicted: 12215$, Target: 12875$
Epoch 181/250, Train Loss: 0.14389518, Test Accuracy: 0.7509/0.1700 Train Accuracy: 0.7388/0.1700, lr:0.00005000
Epoch 182/250, Train Loss: 0.13952813, Test Accuracy: 0.7593/0.1650 Train Accuracy: 0.7533/0.1700, lr:0.00005000
```
...
if __name__ == "__main__":
    ...
    start_ep = 0
    start_ep = load_checkpoint(model, optimizer, "./checkpoint_epoch_135.pt")
